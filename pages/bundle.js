  ...
  return (
    <Layout>
      ...
      <section style={{textAlign:'center',paddingBottom:40}}>
        ...
        <p style={{marginTop:12,fontSize:14}}><a href="https://manduks.gumroad.com/l/iiiwf" target="_blank" rel="noopener noreferrer" style={{color:'var(--text-tertiary)',textDecoration:'underline',textUnderlineOffset:3}}>Also available on Gumroad &rarr;</a></p>
      </section>
