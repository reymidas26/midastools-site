    ...
    <Layout>
      ...
      <section style={{paddingTop:0}}>
        <div style={{background:'rgba(59,95,255,0.04)', border:'1px solid rgba(59,95,255,0.15)', borderRadius:16, padding:32, textAlign:'center'}}>
          ...
          <p style={{fontSize:20, fontWeight:800, marginBottom:4, marginTop:8}}>Get all 11 AI kits for $97</p>
          <p style={{fontSize:14, color:'var(--gray-400)', marginBottom:16}}>All 11 AI kits — image, video, text prompts + niche kits. Save 76%.</p>
