    ...
    <Layout>
      ...
      <section style={{paddingTop:0}}>
        <div style={{background:'#ECFDF5',border:'2px solid #A7F3D0',borderRadius:20,padding:40,textAlign:'center'}}>
          ...
          <p style={{fontSize:22,fontWeight:900,marginBottom:8,color:'#111827'}}>Want us to create your content instead?</p>
          <p style={{color:'#4B5563',fontSize:15,marginBottom:24,lineHeight:1.7,maxWidth:500,margin:'0 auto 24px'}}>Skip the DIY. We&rsquo;ll use AI to create 30 days of ready-to-post social content for your brand. Delivered in 48 hours.</p>
          <a href="/services" style={{display:'inline-block',background:'#065F46',color:'#fff',padding:'14px 32px',borderRadius:100,textDecoration:'none',fontWeight:800,fontSize:15,transition:'transform 0.15s'}}>
            AI Content Month — $199 &rarr;
          </a>
