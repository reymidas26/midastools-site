...
- Suggested risk response strategies for the highest-scoring items`}
        ...
        <div style={{ background: 'linear-gradient(135deg, #EEF2FF 0%, #E0E7FF 100%)', borderRadius: '12px', padding: '32px', margin: '40px 0', textAlign: 'center' }}>
          ...
          <p style={{ color: '#4B5563', marginBottom: '20px' }}>The Complete AI Prompt Bundle includes SaaS, freelancer, small business, marketing, and more &mdash; 8 kits, $302 value. Every prompt tested, organized, and ready to paste.</p>
          <a href={STRIPE_BUNDLE} style={{ display: 'inline-block', background: '#3B5FFF', color: '#fff', padding: '14px 32px', borderRadius: '100px', textDecoration: 'none', fontWeight: '700', fontSize: '16px' }}>Get the Bundle &mdash; $97 (Save 68%) &rarr;</a>
        </div>
