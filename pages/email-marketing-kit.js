    ...
    <Layout>
      ...
      <section style={{paddingTop:0}}>
        <div style={{background:'rgba(232,146,11,0.04)',border:'1px solid rgba(232,146,11,0.15)',borderRadius:16,padding:32,textAlign:'center'}}>
          ...
          <p style={{fontSize:20,fontWeight:800,marginBottom:8}}>Get all 14 AI kits for $97</p>
          <p style={{color:'var(--gray-400)',fontSize:15,marginBottom:20,lineHeight:1.6}}>This kit + 13 more AI kits &mdash; $506 value. Save 81%.</p>
