---
title: "The 14 Questions I Run on Every $997 AI Audit for Solo Operators"
published: true
...
I run a small product company called [Midas Tools](https://www.midastools.co/?utm_source=devto&utm_medium=article&utm_campaign=14-ai-audit-checklist-coaches-consultants). Two weeks ago we productized a service we'd been doing informally for six months: a 7-day **AI Clarity Assessment** for solo coaches and consultants. $997, fully refundable until the discovery call starts.
...
1. **Treating "AI for coaches" courses as substitutes for an audit.** Courses teach you tools. An audit tells you which tools, in what order, for *your* week.

2. **Auditing the easiest workflow first.** Easy workflows aren't bottlenecks — they're just easy. Audit the dreaded one (question #6). The unlock is in the dread.

3. **Confusing "AI saved me time on this email" with "AI saved me 5 hrs/week".** One email is a vibe; 5 hrs/week is a measurable change in your calendar.
...
→ **Free template (all 14 questions + summary):** [midastools.co/audit-template](https://www.midastools.co/audit-template?utm_source=devto&utm_medium=article&utm_campaign=14-ai-audit-checklist-coaches-consultants)

→ **Done-for-you ($997, 7 days, fully refundable):** [midastools.co/ai-audit](https://www.midastools.co/ai-audit?utm_source=devto&utm_medium=article&utm_campaign=14-ai-audit-checklist-coaches-consultants)

→ **Free fix for "AI gives me generic output" (question #7):** [midastools.co/prompt-enhancer](https://www.midastools.co/prompt-enhancer?utm_source=devto&utm_medium=article&utm_campaign=14-ai-audit-checklist-coaches-consultants)

The full 14-question version with comparison tables, common-mistakes deep-dive, and the universal audit-question formula lives as a [GitHub gist here](https://gist.github.com/manduks/a050bba9f1673a7217116c280c3a887e).
